...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<div id="updates" class="boxed"><h2 class="title"></h2><div class="content"><table width="130" border="0"><ul><tr><td width="26"><a href="javascript:irA(0)" title="Crucigrama">1</a></td><td width="26"><a href="javascript:irA(1)" title="¿Qué figura es?">2</a></td><td width="26"><a href="javascript:irA(2)" title="Adivina +-">3</a></td><td width="26"><a href="javascript:irA(3)" title="Sopa de letras">4</a></td><td width="26"><a href="javascript:irA(4)" title="Scrabble">5</a></td></tr><tr></tr></ul></table></div></div>';
...
taboaContidos[0]=new act("Crucigrama","Crucigrama","","<object width='100%' height='420' type='text/html' data='Crucigrama/Crucigrama.htm'></object>",true,"Crucigrama",true,true,false);
taboaContidos[1]=new act("¿Qué figura es?","¿Qué figura es?","","<object width='100%' height='420' type='text/html' data='juego1/juego1.htm'></object>",true,"¿Qué figura es?",true,true,false);
taboaContidos[2]=new act("Adivina +-","Adivina +-","","<object width='100%' height='420' type='text/html' data='Perez/Perez.htm'></object>",true,"Adivina +-",true,true,false);
taboaContidos[3]=new act("Sopa de letras","Sopa de letras","","<object width='100%' height='420' type='text/html' data='sopa_de_letras/sopa_de_letras.htm'></object>",true,"",true,true,false);
taboaContidos[4]=new act("Scrabble","Scrabble","","<object width='100%' height='420' type='text/html' data='Cristian/Juego.htm'></object>",true,"",true,true,false);
